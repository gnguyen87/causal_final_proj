...
### Census Tracts
msp_census_tracts <- read.csv("raw_data/minneapolis-tree-canopy.csv") %>%  select(region_name)
...
zipcode <- st_read('raw_data/shp_bdry_zip_code_tabulation_areas/zip_code_tabulation_areas.shp')
...
social_vulnerability <- read.csv('raw_data/svi_2020.csv')
...
air_pollution_data_mn <- st_read('raw_data/air_pollution_data_mn.csv')
...
tree_canopy <- read.csv('raw_data/minneapolis-tree-canopy.csv')
...
redlining <- st_read('raw_data/141121-V2')
...
racial_covenants <- st_read("raw_data/Hennepin_County_Racial_Covenants")
